    ...
    >
      <div className="z-10 flex flex-col items-center gap-8 text-center">
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-slate-500/20 to-slate-400/20 blur-md" />
          <Image
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <motion.p
            ...
            className="max-w-lg text-slate-500"
          >
            {personalInfo.bio}
          </motion.p>
        </div>
      ...
      >
        <span className="text-xs text-slate-600">{personalInfo.education}</span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
