    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-950">
      ...
      <div className="z-10 flex flex-col items-center gap-8 px-6 text-center">
        ...
        >
          ...
          <p className="max-w-lg text-lg text-slate-400 sm:text-xl">
            Forward Deployed Engineer
            <span className="mx-2 text-slate-600">|</span>
            Simulations & Physics AI
          </p>
        </motion.div>
        ...
        >
          <div className="h-px w-16 bg-gradient-to-r from-transparent via-slate-500 to-transparent" />
          <p className="text-sm uppercase tracking-widest text-slate-500">Coming Soon</p>
        </motion.div>
      ...
      >
        PhD Mechanical Engineering (SciML) | Penn State
      </motion.div>
    </main>
  );
}
